      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 pb-2 border-b border-[#D4AF37]/10 overflow-x-auto">
          <button
            ...
            className={`px-6 py-2.5 rounded-t-lg text-sm font-medium transition-all relative whitespace-nowrap ${selectedCategory === 'all'
              ? 'bg-[#D4AF37] text-black'
              : 'bg-transparent text-gray-400 hover:text-white hover:bg-[#1A1A1A]'
              }`}
          >
            All Categories
            <span className={`ml-2 px-2 py-0.5 rounded-full text-xs ${selectedCategory === 'all'
          ...
          {(['Vacant Land', 'Farms', 'Hotels', 'Investment Portfolios'] as Category[]).map((category) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-t-lg text-sm font-medium transition-all relative whitespace-nowrap ${selectedCategory === category
                ? 'bg-[#D4AF37] text-black'
                : 'bg-transparent text-gray-400 hover:text-white hover:bg-[#1A1A1A]'
                }`}
            >
              {category}
              <span className={`ml-2 px-2 py-0.5 rounded-full text-xs ${selectedCategory === category
                ? 'bg-black/20 text-black font-bold'
                : 'bg-[#D4AF37]/10 text-[#D4AF37]'
                }`}>
                10
